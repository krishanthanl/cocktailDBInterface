...
const CocktailCardActionButton = ({
    handleActionButtonClick,
    cocktailCardMode,
}: ICocktailCardActionButton) => {
    const buttonColor =
        cocktailCardMode === CocktailCardMode.SEARCHING ? 'bg-blue-500' : 'bg-red-500'
    return (
        <div className="p-4 text-center">
            <button
                onClick={handleActionButtonClick}
                className={`mt-2 w-full rounded ${buttonColor} w-100 px-4 py-2 text-white sm:w-auto`}
            >
